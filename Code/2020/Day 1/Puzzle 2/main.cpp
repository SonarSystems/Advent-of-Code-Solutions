    ...
    for ( int i = 0; i < arraySize; i++ )
    {
        for ( int j = 0; j < arraySize; j++ )
        {
            for ( int k = 0; k < arraySize; k++ )
            {
                if ( i != j && i != k )
                {
                    if ( 2020 == array[i] + array[j] + array[k] )
                    {
                        std::cout << "Found" << std::endl;
                        std::cout << array[i] << " + " << array[j] << " + " << array[k] << " = " << array[i] + array[j] + array[k] << std::endl;
                        std::cout << array[i] << " * " << array[j] << " * " << array[k] << " = " << array[i] * array[j] * array[k] << std::endl;
